...
public class App {
    ...
    public static void min_price(ArrayList<Car> cars){
        int min_number = 0;
    ...
    public static void order(ArrayList<Car> cars){
        for (int i = 0; i < cars.size(); ++i) {
    ...
    public static void search(ArrayList<Car> cars, Scanner scanner){
        System.out.println();
